...
class _SeasonPageViewState extends State<SeasonPageView> {
  SeasonsPagePresenter get presenter => context.read();
  ColorScheme get colorScheme => Theme.of(context).colorScheme;
  TextTheme get textTheme => Theme.of(context).textTheme;

  @override
  void initState() {
    if (!presenter.seasonsController[widget.id - 1].hasValue) {
    ...
    return StreamBuilder(
        ...
        builder: (context, loading) {
          return StreamBuilder(
            ...
            stream: presenter.seasonsController[widget.id - 1],
            builder: (context, snapshot) {
              final episodes = snapshot.data!;
              return loading.data == true || episodes.isEmpty
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final number = int.parse(episode.code.split('E').last);
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:
                                    colorScheme.surfaceVariant.withOpacity(.9),
                                blurRadius: 16,
                              ),
                            ],
                          ),
